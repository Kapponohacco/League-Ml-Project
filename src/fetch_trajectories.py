...
def main():
    match_ids = pd.read_parquet("data_raw_silver/match_ids_filtered.parquet")
    ...
    data.to_parquet("data_raw_silver/trajectories.parquet", index=False)
    data.to_csv("data_raw_silver/trajectories.csv", index=False)
